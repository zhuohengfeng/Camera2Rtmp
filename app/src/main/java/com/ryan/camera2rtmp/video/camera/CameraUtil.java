...
import com.ryan.camera2rtmp.utils.SPUtil;

import java.io.IOException;
import java.util.List;

/**
 * camera 操作类，基于camera1 api
 */
public class CameraUtil {
    ...
    public void openCamera() {
        ...
        for (int i = 0; i < numCameras; i++) {
            ...
            if (info.facing == mCurrentCameraType) {
                cameraId = i;
        ...
        parameters.setPreviewFormat(ImageFormat.NV21); // 设置的是NV21格式
        ...
        Logger.d("preview cameraWidth="+cameraWidth+", cameraHeight="+cameraHeight);
